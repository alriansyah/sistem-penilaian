...
<head>
    ...
    <link href="{{ asset('assets/vendor/fontawesome-free-6.3.0-web/css/all.min.css') }}" rel="stylesheet"
        type="text/css">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">@yield('name')</span>
                                @yield('foto-profil')
